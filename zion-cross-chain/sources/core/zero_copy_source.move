module Bridge::zero_copy_source {
    ...
    public fun next_u32(bs: &vector<u8>, offset: u64): (u64, u64) {
        ...
        return (zion_utils::to_u64(res), offset+4)
    }
    ...
    public fun next_u256(bs: &vector<u8>, offset: u64): (u128, u128, u64) {
        let low_bcs = zion_utils::slice<u8>(bs, offset, 16);
        let high_bcs = zion_utils::slice<u8>(bs, offset+16, 16);
        return (zion_utils::to_u128(high_bcs), zion_utils::to_u128(low_bcs), offset+32)
    }
