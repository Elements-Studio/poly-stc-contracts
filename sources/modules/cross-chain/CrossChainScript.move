...
module CrossChainScript {
    ...
    use NamedAddr::CrossChainManager;
    use NamedAddr::CrossChainRouter;
    use NamedAddr::LockProxy;
    use NamedAddr::XETH;
    use NamedAddr::XUSDT;
    ...
    const PROXY_HASH_STARCOIN: vector<u8> = b"NamedAddr::CrossChainScript";

    const ASSET_HASH_STC: vector<u8> = b"0x00000000000000000000000000000001::STC::STC";
    const ASSET_HASH_XETH: vector<u8> = b"NamedAddr::XETH::XETH";
    const ASSET_HASH_XUSDT: vector<u8> = b"NamedAddr::XUSDT::XUSDT";
