...
module EthStateVerifier {
    ...
    fun init_eth_account(): (vector<u8>,
                                    u64,
                                    vector<u8>,
                                    u128,
                                    u64,
    ...
    fun init_storage_proof(): (vector<u8> ,vector<u8> ,vector<vector<u8>>) {
        ...
        (
            key_hex,
            value_hex,
            init_storage_proof_proof()
        )
    }
    
    fun init_storage_proof_proof(): vector<vector<u8>> {
    ...
    public fun test_account_prove() {
        ...
        let result = EthStateVerifier::verify(state_root, addr, account_proof, expected_value);
    ...
    public fun test_storage_prove() {
        ...
        let result = EthStateVerifier::verify(storage_hash, key, proof, expected_value);
