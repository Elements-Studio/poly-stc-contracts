address Bridge {
    ...
    module StarcoinVerifier {
        ...
        fun init_starcoin_proof(): (vector<u8>,
                                    vector<u8>,
                                    vector<vector<u8>>,
                                    vector<vector<u8>>,
                                    vector<vector<u8>>,
                                    ...
                                    vector<u8>,
                                    vector<u8>) {
            let (account_proof_leaf,account_proof_siblings) = init_account_proof();
            let (account_state_proof_leaf,account_state_proof_siblings) = init_account_state_proof();
            (
                x"",
                x"02012042f8b41b427b440624d2e0c09df070591e6a04fe97ae60ed0ee05fc7ff6aa087012032ed8f47f7fc3523fa63d814cfd96a5bb4c35433e2ecdc144e8e0e11ba87bd25",
                ...
                x"69cd2d882c034f2cc1f2548a79df15dd983463c4ec0ab48219decf2d948969d6",
                x"598b8cbfd4536ecbe88aa1cfaffa7a62",                
            )
        }

        fun init_account_proof(): (vector<vector<u8>>,
                                vector<vector<u8>>) {
        ...
        fun init_account_state_proof(): (vector<vector<u8>>,
                                                vector<vector<u8>>) {
        ...
        public fun test_state_prove() {
            let (
                ...
                _account_proof_leaf,
                account_proof_siblings,
                _account_state_proof_leaf,
                _account_state_proof_siblings,
                state_root,
                addr,
            ) = init_starcoin_proof();

            let expected_root = state_root;
            let account_address = addr;
            let proof = account_proof_siblings;
            let account_state_root_hash = MerkleProofStructuredHash::hash<vector<u8>>(b"Blob", &account_state);
